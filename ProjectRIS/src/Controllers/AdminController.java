	...
	public void addNewOrder(ActionEvent event) throws IOException {
		 Connection conn = null;
	      ...
	      try {
	       ...
	       String query1 = "INSERT INTO orders(patient,referral_md,modality,notes) VALUES  ('"+PatientFirstName.getText()+" "+PatientLastName.getText()+"', '"+OrderReferralMD.getText()+"', '"+OrderModalityNeeded.getText()+"', '"+OrderNotes.getText()+"')";
